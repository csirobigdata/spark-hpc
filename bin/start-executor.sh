...
export SPARK_EXECUTOR_OPTS="$SPARKHPC_JAVA_OPTS $SPARKHPC_EXECUTOR_OPTS ${SPARKHPC_OVERRIDE_OPTS}"
...
export LD_LIBRARY_PATH="${SPARKHPC_EXECUTOR_LIBRARY_PATH}:${SPARKHPC_JAVA_LIBRARY_PATH}:${LD_LIBRARY_PATH}"
